...
export default function NewTeacherPage() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (photo) {
        photoUrl = await uploadFile(photo, `teachers/${Date.now()}_${photo.name}`);
      }
      ...
      alert(error.message || "শিক্ষক যোগ করা ব্যর্থ হয়েছে");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">নতুন শিক্ষক</h1>
      </div>
