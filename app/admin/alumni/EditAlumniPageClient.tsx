...
export default function EditAlumniPageClient({ id }: EditAlumniProps) {
    ...
    const loadAlumni = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          setValue("published", alumniData.published);
        }
      } catch (error: any) {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const isPublished =
        typeof data.published === "string" ? data.published === "true" : !!data.published;
